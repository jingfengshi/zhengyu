...
@section("content")
    ...
    <div class="product-info-file-box">点击下载 <a href="{{URL::asset('uploads').'/'.$product->file}}">{{$product->title}}</a> 相关资料</div>
        ...
        <div class="more-product-box-list-box swiper-container">
            <div class="swiper-wrapper">
                ...
                @foreach($products as $product)
                    <div class="more-product-box-list-box-item swiper-slide" style='background: url("{{URL::asset('uploads').'/'.$product->image}}"); background-size: 100% 100%; background-repeat: no-repeat;'>
                        <div class="more-product-box-list-box-item-mask"></div>
                        <a href="/product-info/{{$product->id}}"><div class="more-product-box-list-box-item-button font-color-white text-overflow">{{$product->title}}</div></a>
                    </div>
                @endforeach

{{--                <div class="more-product-box-list-box-item swiper-slide" style='background: url("{{URL::asset('images/static/project.jpg')}}"); background-size: 100% 100%; background-repeat: no-repeat;'>--}}
{{--                    <div class="more-product-box-list-box-item-mask"></div>--}}
