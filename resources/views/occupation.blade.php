...
@section("content")
    ...
    text-align: center;margin: auto">
       ...
       margin: auto;margin-top: 2rem;">
        ...
        <div style="width: 192px;height: 45px; font-weight: 200;padding-top:200px; margin-top:-150px;
    font-style: normal;
    font-size: 32px;
    text-align: center;margin: auto;  color:#333333;margin-bottom: 50px;" id="jiazhiguan">
            我们的价值观
        </div>
