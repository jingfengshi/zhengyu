...
@section("content")
    ...
    background-color: #ffffff;z-index: 9998;"@endif>
        ...
        <div style="width: 91%;margin:0 auto;">
			...
			<div class="cusytdesc">正域认为“优质的设备要由优质安全的产品来构成，而优质安全的产品又是用优质的原材料来制作”
这一基本理念，在重视品质和交货期、保护环境等多个方面上正在不断地
加强合作关系。以追求更高的品质和服务为目标，严格的质量把控、及时的交付是我们
欣赏的优良品质，这也使上海正域与供应商之间的关系更加紧密。</div></div>


            <div class="brand-title" style="padding-right: 240px;">倾听员工心声</div>
            <div class="brand-desc" style="padding-right: 240px;"><div class="cusytdesc">我们为员工感到骄傲。我们鼓励员工大胆思考，提出问题并挑战传统思维——无需担心失败。
员工公开分享自己的才华和想法并诞生创意。所以我们致力于营造一种尊重与包容的文化氛围，
使上海正域的每位员工及其创新思想都能蓬勃发展。</div></div>


            <!--<div style="height: 180px;width: 1920px;" id="foward"></div>-->
            <div class="brand-title" id="foward" style="padding-right: 240px;padding-top:200px; margin-top:-150px;">共同推动行业前进</div>
            <div class="brand-desc" style="padding-right: 240px;">
                <div class="cusytdesc">1. 上海正域的采购员对待供应商要注重礼仪，要公平公正并且诚实地应对处理。<br/>
·  以社会一员的良知和礼仪，带着责任心去执行采购业务。<br/>
·  和供应商保持友好关系，和供应商之间不发生任何私人的利害关系。<br/>
·  遵守法令法规以及公司规定。<br/>

2. 与供应商进行交易时 <br/>
选择供应商时，应针对其品质，价格，交货时期，供给的连续性，环境保护，财务，对人权和劳动安全卫生等
各个方面的考虑，根据以上合理基准，公正公平地进行评估选择。<br/>
