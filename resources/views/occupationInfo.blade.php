...
@section("content")
    ...
    background-color: #ffffff;z-index: 9998;">
        ...
        <div style="width: 100%;height: 450px;margin: auto;overflow:hidden;margin-top: 210px;">
            <img style="height:450px;width: 100%;" src="{{URL::asset('images/职业/u4605.jpg')}}"
                 alt="">
        </div>


        <div style="width: 100%;margin: auto;margin-top:6.2rem;">
            <div style="width: 288px;height: 45px;font-weight: 400;
                 font-style: normal;
                 font-size: 32px;
                 color:#555555;
            ...
            <div style="width: 1300px;height:75px;font-weight: 300;
                  font-style: normal;
                  font-size: 26px;
                  color:#555555;
                  line-height: 3rem;
        ...
        <div style="display: flex;margin:auto;width:1300px;">
            <div style="width:420px;height: 459px;margin-right: 2rem">
                ...
                <div style="padding-left: 1rem;padding-top: 2rem">
                    <div style="width: 125px;height: 40px;ont-weight: 300;
                        font-style: normal;
                        color:#555555;
            ...
            <div style="width:420px;height: 459px;margin-right: 2rem">
                ...
                <div style="padding-left: 1rem;padding-top: 2rem">
                    <div style="width: 125px;height: 40px;ont-weight: 400;
                        font-style: normal;
                        color:#555555;
                        text-align: left;font-size: 28px;">
                        福利待遇
        ...
        <div style="display: flex;margin:auto;margin-top: 6rem;width:1300px">
            <div>
                <img src="{{URL::asset('images/job.jpg')}}" alt="">
            </div>
            <div style="margin-left: 2rem">
                <div style="width: 130px;height: 45px;font-weight: 400;
                     font-style: normal;
                     color:#555555;
                     font-size: 32px;
                     text-align: center;">
                ...
                <div style="width: 781px;height: 46px;font-weight: 300;
                    font-style: normal;
                    font-size: 24px;
                    color:#555555;
                ...
                <div style="padding-top: 11rem">
                    <span style="color:#02A7F0;font-weight: 400;
                          font-style: normal;font-size: 22px; ">所有岗位请点击：</span>
                    <span style="font-weight: 200;
                           font-style: normal;
                           font-family：Arail
                           color:#555555;
                           font-size: 24px;">https://qy.58.com/3027416113927</span>
                    ...
                    <div style="width: 140px;height: 40px;background-color: rgba(3, 100, 210, 1);
                        ...
                        box-shadow: none;
                        font-size: 14px;text-align: center;padding-top: 0.5rem;float: right ;margin-right: 2rem;">
