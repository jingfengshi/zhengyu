...
<div class="product-box">
    <div class="item">
        <div class="item-top"><img src="images/static/banner-3.jpg" alt=""></div>
        <div class="item-bottom">
            <div class="item-bottom-title">视觉信号</div>
            <div class="item-bottom-desc">设别信号设别信号设别信号设别信号设别信号设别信号设别信号设别信号设别信号设别信号设别信号设别信号设别信号设别信号</div>
        </div>
    </div>
    <div class="item">
        <div class="item-top"><img src="images/static/banner-3.jpg" alt=""></div>
